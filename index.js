...
const vcard = 'BEGIN:VCARD\n' 
            ...
            + 'FN:Zharzx\n' //ganti nama lu! 
            + 'ORG: ZHARZXCHAMNEL;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=6285131562716:+62 85713902205\n'  //ganti nomor lu! 
            + 'END:VCARD'
prefix = '#'
blocked = []   
limitawal = 99999
...
/******** OWNER NUMBER**********/
const ownerNumber = ["6285131562716@s.whatsapp.net"]   //ganti nomor lu! 
...
const client = new WAConnection()
   ...
   console.log(color('[','white'),color('∆','red'),color(']','white'),color('QR code is ready, Scan now..','white'),color('ZharzxChannelツ','red'),color('X','lime'),color('FxSx','red'))
})
...
* @${num.split('@')[0]}\n━━⊱ ❰ *SELAMAT JALAN AKU DAPAT BERKAT NASI* ❱ ⊰━━`
	...
	client.on('message-new', async (mek) => {
            ...
            if (bad.includes(messagesC)) {
                if (!isGroupAdmins) {
                    return reply("JAGA UCAPAN DONG!! 😠")
                        ...
                        .then(() => {
                            client.sendMessage(from, `*「 ANTI BADWORD 」*\nZHARZX CHANNEL akan kick kamu karena berkata kasar!`, text ,{quoted: mek})
		...
		setTimeout( () => {
			...
			switch(command) {
				case 'nobadword':  // Fix Bug By BOTOPERATORIVTY & zain*
				...
				case 'addbadword':  // Fix Bug By BOTOPERATORIVTY & zain*
                    ...
                    break
                case 'delbadword':  // Fix Bug By BOTOPERATORIVTY & zain*
                    if (!isOwner) return reply(ind.ownerb())
                    if (!isGroupAdmins) return reply(ind.admin())
                    if (args.length < 1) return reply( `Kirim perintah ${prefix}addbadword [kata kasar]. contoh ${prefix}addbadword bego`)
                    ...
                    break 
                case 'listbadword':  // Fix Bug By BOTOPERATORIVTY & zain*
		...
		case 'transfer':
				...
				if (!q.includes('|')) return  reply(ind.wrongf())
                		...
                		addKoinUser('6285131562716@s.whatsapp.net', fee)
		...
		case 'giftlimit': 
				...
				const nomerr = args[0].replace('@','')
                		...
                		if (!nomerr) return reply(`maaf format salah\nmasukan parameter yang benar\ncontoh : ${prefix}giftlimit @6285131562716 20`)
		...
		case 'grouplist':
                 ...
                 if (!isRegistered) return reply( ind.noregis())
					client.updatePresence(from, Presence.composing) 
					teks = `\`\`\`Ini adalah list group ZHARZX CHANNEL :\n\n\`\`\``
					no = 0
...
┣𖥻ꦼꦽ➳${prefix}simih [1/0] 
┣𖥻ꦼꦽ➳${prefix}promote [@tag]
┣𖥻ꦼꦽ➳${prefix}demote [@tag]
┣𖥻ꦼꦽ➳${prefix}tagall
┣𖥻ꦼꦽ➳${prefix}listadmin
┣𖥻ꦼꦽ➳${prefix}wakillist
┣𖥻ꦼꦽ➳${prefix}premiumlist
┣𖥻ꦼꦽ➳${prefix}banlist
┣𖥻ꦼꦽ➳${prefix}blocklist
┣𖥻ꦼꦽ➳${prefix}linkgc
┣𖥻ꦼꦽ➳${prefix}mining
┣𖥻ꦼꦽ➳${prefix}hidetag
┣𖥻ꦼꦽ➳${prefix}grouplist
┣𖥻ꦼꦽ➳${prefix}add [62]
┣𖥻ꦼꦽ➳${prefix}kick [@tag]
┣𖥻ꦼꦽ➳${prefix}setname
┣𖥻ꦼꦽ➳${prefix}setdesc
...
JANGAN LUPA SUBS MY CHANNEL ZHARZX CHANNEL https://youtube.com/channel/UCpsA_nCZZ87CIjM6JHoi3sg
` 

                    client.sendMessage(from, wew, image, { quoted: mek, caption: zain })
					break
		case 'donasi':
		case 'donate':
		...
		case 'lpr':
					...
					client.sendMessage('6285131562716@s.whatsapp.net', options, text, {quoted: mek})
					reply('Masalah telah di laporkan ke owner ZHARZX CHANNEL Laporan palsu atau main² tidak akan ditanggapi.')
					break
		case 'request':
					...
					client.sendMessage('6285131562716@s.whatsapp.net', options, text, {quoted: mek})
					client.sendMessage('6285131562716@s.whatsapp.net', options, text, {quoted: mek})
					reply('REQUEST ANDA TELAH SAMPAI KE OWNER ZHARZX CHANNEL Requests palsu atau main² tidak akan ditanggapi.')
					break
		case 'blocklist': 
		...
		case 'bc': 
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							sendMess(_.jid, `*「 BROADCAST ZHARZX CHANNEL 」*\n\n${body.slice(4)}`)
						}
						reply('*Suksess broadcast* ')
					}
					break
